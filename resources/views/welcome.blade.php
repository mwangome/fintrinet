...
<body class="home blog custom-background nx-wide onecol-blog single-author nx-preloader nx-no-search" style="  ">
            ...
            <div id="da-slider" class="da-slider" role="banner" data-slider-speed="6000" data-slider-height="100" data-slider-reduct="260" data-slider-parallax="1">
                <div class="nx-slider">
                    ...
                    <div class="slider-content-wrap">
                        <div class="nx-slider-container">
                            ...
                            <p>Much more than just a company...</p><a href="about/" class="da-link">Learn More</a>
                        </div>
                    </div>
                </div>
                <div class="nx-slider">
                    ...
                    <div class="slider-content-wrap">
                        <div class="nx-slider-container">
                            ...
                            <p>To build momentum for rapid economic recovery, create jobs, turn Kenya into a major export economy and deliver the Vision 2030.</p><a href="#" class="da-link">Learn More</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="nx-slider">
                    ...
                    <div class="slider-content-wrap">
                        <div class="nx-slider-container">
                            <h2>Contact Us</h2>
                            <p>Call us to schedule an appointment...</p><a href="contact/" class="da-link">Learn More</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <footer id="colophon" class="site-footer" role="contentinfo">
                            ...
                            <aside id="nav_menu-2" class="widget widget_nav_menu">
                                <div class="menu-footer_menu-container">
                                    <ul id="menu-footer_menu" class="menu">
                                        <li id="menu-item-332" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home menu-item-332"><a href="/" aria-current="page">Home</a></li>
            ...
            <div class="site-info">
                ...
                <div class="credit-info">
                    ...
                    Designed and Developed by LITES </a>
                </div>
